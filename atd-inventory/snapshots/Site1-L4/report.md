...
Et1                            up             up                 SERVER_Site1-L3=Site1-L4=vPC1_NIC2
Et2                            up             up                 SERVER_Site1-L3=Site1-L4=vPC2_NIC2
...
Et47                           up             up                 
Et48                           up             up                 
Et49/1                         up             up                 MLAG_Site1-L3_Ethernet49/1
Et50/1                         up             up                 MLAG_Site1-L3_Ethernet50/1
Et51/1                         up             up                 P2P_Site1-S1_Ethernet4/1
Et52/1                         up             up                 P2P_Site1-S2_Ethernet4/1
Et53/1                         up             up                 P2P_Site1-S3_Ethernet4/1
Et54/1                         up             up                 
Et55/1                         up             up                 
Et56/1                         up             up                 
Lo0                            up             up                 ROUTER_ID
...
Po491                          up             up                 MLAG_Site1-L3_Port-Channel491
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet3       10.192.144.254/24     up         up              1500          
Ethernet51/1    172.30.255.79/31      up         up              9000          
Ethernet52/1    172.30.255.81/31      up         up              9000          
Ethernet53/1    172.30.255.83/31      up         up              9000          
Loopback0       192.0.255.16/32       up         up             65535          
Loopback1       192.0.254.15/32       up         up             65535          
Loopback100     10.255.1.16/32        up         up             65535          
Loopback200     10.255.2.16/32        up         up             65535          
...
Vlan3009        10.255.251.25/31      up         up              9000          
Vlan3019        10.255.251.25/31      up         up              9000          
Vlan4093        10.255.251.25/31      up         up              9000          
...
```
Last table change time   : 0:55:40 ago
...
------------ ------------------------ ---------------------- ---
Et1             Site1-Host3              Ethernet2           120
Et2             Site1-Host4              Ethernet2           120
Et49/1          Site1-L3.act.lab         Ethernet49/1        120
Et50/1          Site1-L3.act.lab         Ethernet50/1        120
Et51/1          Site1-S1.act.lab         Ethernet4/1         120
Et52/1          Site1-S2.act.lab         Ethernet4/1         120
Et53/1          Site1-S3.act.lab         Ethernet4/1         120
```
## show running-config

```
! Command: show running-config
! device: Site1-L4 (vEOS-lab, EOS-4.32.2F)
!
...
username cvpadmin privilege 15 role network-admin secret sha512 $6$YtU/7t2hmY8DZitB$EDGeWOhvHFDVkcgMUuBk6e.UOwHVswnOvb4XFlCcrN6PWktOnriF3bNDHxynO7fFO0zyjtbe39i6DRmkv7L76.
!
...
interface Port-Channel491
   description MLAG_Site1-L3_Port-Channel491
   switchport mode trunk
   switchport trunk group MLAG
!
interface Ethernet1
   description SERVER_Site1-L3=Site1-L4=vPC1_NIC2
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_Site1-L3=Site1-L4=vPC2_NIC2
...
interface Ethernet50/1
   description MLAG_Site1-L3_Ethernet50/1
   channel-group 491 mode active
!
interface Ethernet51/1
   description P2P_Site1-S1_Ethernet4/1
   mtu 9000
   no switchport
   ip address 172.30.255.79/31
!
interface Ethernet52/1
   description P2P_Site1-S2_Ethernet4/1
   mtu 9000
   no switchport
   ip address 172.30.255.81/31
!
interface Ethernet53/1
   description P2P_Site1-S3_Ethernet4/1
   mtu 9000
   no switchport
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description Site1-L3
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.251.24 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.24 description Site1-L3_Vlan4093
   neighbor 172.30.255.78 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.78 remote-as 65001
   neighbor 172.30.255.78 description Site1-S1_Ethernet4/1
   neighbor 172.30.255.80 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.80 remote-as 65001
   neighbor 172.30.255.80 description Site1-S2_Ethernet4/1
   neighbor 172.30.255.82 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.82 remote-as 65001
   neighbor 172.30.255.82 description Site1-S3_Ethernet4/1
...
Arista vEOS-lab
Hardware version: 
Serial number: 440cfbdf3f6d4b729a589c6a200cb93c
Hardware MAC address: 8486.c06a.741a
System MAC address: 8486.c06a.741a
