...
Et1                            up             up                 test eth1 trunk port
...
Et49/1                         down           down               
Et50/1                         down           down               
Et51/1                         up             up                 P2P_Site2-S1_Ethernet1/1
Et52/1                         up             up                 P2P_Site2-S2_Ethernet1/1
Et53/1                         up             up                 P2P_Site2-S3_Ethernet1/1
Et54/1                         down           down               
Et55/1                         down           down               
Et56/1                         down           down               
Lo0                            up             up                 ROUTER_ID
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet2       10.192.211.254/24     up         up              1500          
Ethernet51/1    172.32.255.121/31     up         up              9000          
Ethernet52/1    172.32.255.123/31     up         up              9000          
Ethernet53/1    172.32.255.125/31     up         up              9000          
Loopback0       192.2.255.23/32       up         up             65535          
Loopback1       192.2.254.23/32       up         up             65535          
Loopback100     10.255.1.23/32        up         up             65535          
Loopback200     10.255.2.23/32        up         up             65535          
Management1     192.168.0.23/24       up         up              1500          
...
------------ ------------------------ ---------------------- ---
Et1             Site2-Host1              Ethernet1           120
Et2             Site2-Host1              Ethernet2           120
Et51/1          Site2-S1.act.lab         Ethernet1/1         120
Et52/1          Site2-S2.act.lab         Ethernet1/1         120
Et53/1          Site2-S3.act.lab         Ethernet1/1         120
```
## show running-config

```
! Command: show running-config
! device: Site2-L1 (vEOS-lab, EOS-4.32.2F)
!
...
username cvpadmin privilege 15 role network-admin secret sha512 $6$/zIz1wwBneY0f9Wb$A7PrdnxVAVdcqENVPoI0.ByHTaIjqGtjdJVyLo.c.pwmSoELw4M2t1doaBo22OJAoIH8E4IaMe6ME1a5T.zSw0
!
...
interface Ethernet51/1
   description P2P_Site2-S1_Ethernet1/1
   mtu 9000
   no switchport
   ip address 172.32.255.121/31
!
interface Ethernet52/1
   description P2P_Site2-S2_Ethernet1/1
   mtu 9000
   no switchport
   ip address 172.32.255.123/31
!
interface Ethernet53/1
   description P2P_Site2-S3_Ethernet1/1
   mtu 9000
   no switchport
   ip address 172.32.255.125/31
!
...
ip address virtual source-nat vrf redvrf address 10.255.2.23
!
ip routing
...
router bgp 65201
   ...
   neighbor 172.32.255.120 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.120 remote-as 65002
   neighbor 172.32.255.120 description Site2-S1_Ethernet1/1
   neighbor 172.32.255.122 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.122 remote-as 65002
   neighbor 172.32.255.122 description Site2-S2_Ethernet1/1
   neighbor 172.32.255.124 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.124 remote-as 65002
   neighbor 172.32.255.124 description Site2-S3_Ethernet1/1
...
Arista vEOS-lab
Hardware version: 
Serial number: 9703fbca71f5420f980d66d9dc49112c
Hardware MAC address: 8454.a20a.74c1
System MAC address: 8454.a20a.74c1
