...
Et53/1          Site2-S3.act.lab         Ethernet2/1         120
```
## show running-config

```
! Command: show running-config
! device: Site2-L2 (vEOS-lab, EOS-4.32.2F)
!
...
Arista vEOS-lab
Hardware version: 
Serial number: 614d872ddc3c4138b816adb3e67a485a
Hardware MAC address: 841d.0427.f3f8
System MAC address: 841d.0427.f3f8
